...
<body>
    <div class="contenedor" id="app">
        <div id="sidebar" class="">
            ...
            <ul>
                <li>
                    <img src="IMG/icon Manager.png" alt="Icon Manager" class="icon">
                </li>
                <li>
                ...
                <li>
                    <a href="Administration.php"><img src="IMG/Administration.png" alt="Icono de Admin" class="Admin">ADMINISTRATION</a>
                </li>
                <li>
                    <a href="Users.php"><img src="IMG/Users.png" alt="Icono de Users" class="Users">USERS</a>
                </li>
                <li>
                    <a href="Products.php"><img src="IMG/products.png" alt="Icono de products" class="Products">VIEW PRODUCTS</a>
                </li>
                <li>
                    <a href="Sales.php"><img src="IMG/Sales.png" alt="Icono de Sales" class="Sales">SALES</a>
                </li>
                <!--<li>
                    <a href="Inventory.php"><img src="IMG/Inventory.png" alt="Icono de Inventory" class="Inventory">INVENTORY</a>
                </li>-->
                <li>
